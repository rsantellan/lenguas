<!DOCTYPE html>
<html lang="es">
<title>Historia lingüística del Uruguay | Documentos portugués siglo XIX</title>
<?php $pagina = 'documentos';?>
<?php $item = 'doc_XIX_pt';?>
    ...
    <body id="top" class="has-header-search">
        ...
        <section class="page-title ptb-50">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <ol class="breadcrumb">
                            <li><a href="index.php">Documentos</a></li>
                            <li class="active">Documentos portugués siglo XIX</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <section class="section-padding">
            <div class="container">
              ...
              <div class="mb-80">
                  <h2 class="section-title text-uppercase section-sub">Prólogo</h2>
                  ...
                  <a href="documentos/Documentos-para-la-historia-del-portgues-en-el-Uruguay.pdf" target="blank" class="waves-effect waves-light btn red red-left">ver texto completo</a>
                  <a href="documentos/Normas-de-transcripcion-2012-3.pdf" class="normas-transcripcion" target="blank">Ver Normas de transcripción</a></p>
              </div>
            </div><!-- /.container -->
        </section>
